...
@TRAINERS.register("HGIKT_Hyper_Only_Unweighted")
class HGIKTHyperOnlyUnweightedTrainer(BaseTrainer):
    ...
    def __init__(
        ...
        # 1. Prepare data
        from model.HGIKT.variants.hgikt_hyper_only_unweighted_data import HGIKTHyperOnlyUnweightedData
        ...
        # 2. Initialize model
        from model.HGIKT.variants.hgikt_hyper_only_unweighted import HGIKT_Hyper_Only_Unweighted
        ...
        self.with_training(epochs=args.epochs, seed=args.seed, device=args.device, checkpoint_path=args.checkpoint_path) \
            ...
            .with_experiment(exp_manager=exp_manager, hyperparams=args, model_name="HGIKT_Hyper_Only_Unweighted", dataset_name=getattr(args, "dataset", "")) \
            .build()
