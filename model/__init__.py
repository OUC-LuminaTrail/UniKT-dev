...
TRAINERS.register_lazy("TCKT", "model.TCKT.TCKT_trainer", "TCKTTrainer")
TRAINERS.register_lazy("FAKT", "model.FAKT.FAKT_trainer", "FAKTTrainer")
TRAINERS.register_lazy("DAGKT", "model.DAGKT.DAGKT_trainer", "DAGKTTrainer")
...
TRAINERS.register_lazy("StableKT", "model.StableKT.StableKT_trainer", "StableKTTrainer")
...
TRAINERS.register_lazy("IEKT", "model.IEKT.IEKT_trainer", "IEKTTrainer")
...
TRAINERS.register_lazy("MCSKT", "model.MCSKT.MCSKT_trainer", "MCSKTTrainer")
...
PARAM_CONFIGS.register_lazy("TCKT", "model.TCKT.TCKT_trainer", "TCKTModelParams")
PARAM_CONFIGS.register_lazy("FAKT", "model.FAKT.FAKT_trainer", "FAKTModelParams")
PARAM_CONFIGS.register_lazy("DAGKT", "model.DAGKT.DAGKT_trainer", "DAGKTModelParams")
...
PARAM_CONFIGS.register_lazy(
    "StableKT", "model.StableKT.StableKT_trainer", "StableKTModelParams"
)
...
PARAM_CONFIGS.register_lazy("IEKT", "model.IEKT.IEKT_trainer", "IEKTModelParams")
...
PARAM_CONFIGS.register_lazy("MCSKT", "model.MCSKT.MCSKT_trainer", "MCSKTModelParams")
PARAM_CONFIGS.register_lazy(
    "extraKT", "model.extraKT.extraKT_trainer", "extraKTModelParams"
)
PARAM_CONFIGS.register_lazy("MTKT", "model.MTKT.MTKT_trainer", "MTKTModelParams")
