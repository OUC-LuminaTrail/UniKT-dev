"""HGIKT variant with QS+SA heterogeneous graph branch only."""
...
@register_model("HGIKT_QS_SA_Only")
class HGIKT_QS_SA_Only(nn.Module):
    """HGIKT variant with only Question-Skill (QS) and Skill-Assignment (SA) edges.
