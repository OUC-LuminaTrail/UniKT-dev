...
class StableKTModelData(SkillModelData):
    """StableKT 模型数据加载器

    负责处理数据的预处理和加载，为 StableKT 模型提供训练和验证数据。
    ...
    def prepare_data(self, args: Any) -> tuple:
        ...
        logger.debug(
            f"StableKT data prepared: train={len(train_dataset)}, "
