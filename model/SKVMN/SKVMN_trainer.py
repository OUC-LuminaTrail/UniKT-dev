...
@register_model_config("SKVMN")
class SKVMNConfig(ModelConfig):
    """SKVMN model configuration.
...
class SKVMNTrainer(BaseTrainer):
    ...
    def build_components(self, rc, data_src):
        from model.SKVMN.SKVMN_data import SKVMNModelData

        model_data = SKVMNModelData(data_src)
        train_dataset, val_dataset, test_dataset = model_data.prepare_data(rc)

        from model.SKVMN.SKVMN_model import SKVMN

        logger.info("Initializing SKVMN model...")
