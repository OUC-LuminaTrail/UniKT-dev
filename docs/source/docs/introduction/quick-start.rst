...
.. tip::
   ...
   CPU、Mamba、DHG 等环境或手动 Conda 安装方式请参考\ :doc:`环境配置 <setup>`\ 。
...
1. :doc:`下载 <../experiment-guide/data-processing>` 原始数据集
2. :doc:`处理 <../experiment-guide/data-processing>` 数据为标准化格式，生成 K 折划分
3. :doc:`训练 <../experiment-guide/training-evaluation>` 知识追踪模型
4. :doc:`评估 <../experiment-guide/evaluation>` 模型性能
...
- :doc:`配置系统 <../advanced-guide/config>` — 了解命令行参数
- :doc:`模型评估 <../experiment-guide/evaluation>` — 解读评估指标
- :doc:`添加新模型 <../experiment-guide/new-model>` — 接入自己的模型
